...
# summary statistics
knitr::kable(Pmisc::lmeTable(reading_model))
# estimated marginal means for T_assignment
summary(emmeans(reading_model, ~ T_assignment))
...
# variance-covariance
var(cbind(clean_data_reading$Posttest_READING[clean_data_reading$T_assignment == '0'], 
          clean_data_reading$Posttest_READING[clean_data_reading$T_assignment == '1']))
...
# summary statistics
knitr::kable(Pmisc::lmeTable(language_model))
# estimated marginal means for T_assignment
summary(emmeans(language_model, ~ T_assignment))
...
par(mfrow = c(2, 2))
# histogram 
hist(random_effec2, xlab = 'Random effect', main = 'Histogram of random effect')
# qq plot
...
# variance-covariance
var(cbind(clean_data_language$Posttest_LANGUAGE[clean_data_language$T_assignment == '0'], 
          clean_data_language$Posttest_LANGUAGE[clean_data_language$T_assignment == '1']))
...
# summary statistics
knitr::kable(Pmisc::lmeTable(vocabulary_model))
# estimated marginal means for T_assignment
summary(emmeans(vocabulary_model, ~ T_assignment))
...
# variance-covariance
var(cbind(clean_data_vocabulary$Posttest_VOCABULARY[clean_data_vocabulary$T_assignment == '0'], 
          clean_data_vocabulary$Posttest_VOCABULARY[clean_data_vocabulary$T_assignment == '1']))
...
# summary statistics
knitr::kable(Pmisc::lmeTable(overall_model))
# estimated marginal means for T_assignment
summary(emmeans(overall_model, ~ T_assignment))
...
# variance-covariance
var(cbind(clean_data_overall$Posttest_ELA.TOTAL[clean_data_overall$T_assignment == '0'], 
          clean_data_overall$Posttest_ELA.TOTAL[clean_data_overall$T_assignment == '1']))
